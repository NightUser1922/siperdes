        ...
        <div class="card-body p-4">
            <div class="d-flex gap-3 align-items-start">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Pilih template DOCX, isi placeholder, lalu preview atau generate PDF.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form id="suratKeluarTemplateForm" action="{{ url('/surat-keluar/store') }}" method="POST">
                        ...
                        <div class="border rounded-4 p-3">
                            ...
                            <div class="mb-3">
                                <label for="id_template" class="form-label fw-semibold">Template Surat <span class="required-dot">*</span></label>
                                <select class="form-select" id="id_template" name="id_template" required>
